...
def collate_to_sparse_tensors(batch, protein_input_size=26**3, compound_input_size=1024):
    proteins_indexes = [[], []]
    compounds_indexes = [[], []]
    y = []
    n_samples = len(batch)
    ...
    return ({"protein_input": protein_input, "compound_input": compound_input}, torch.FloatTensor(y))
